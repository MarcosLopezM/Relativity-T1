    ...
    \begin{exercise}
        ...
        \begin{enumerate}[label = \alph*)]
            ...
            \begin{enumerate}[label = \arabic*.]
                ...
                \begin{equation*}
                    \boxed{\rho = \SI[per-mode = power]{10}{\kilogram \per \cubic\metre}}
                \end{equation*}
            \end{enumerate}
            ...
            \begin{enumerate}[label = \arabic*.]
                ...
                \begin{align*}
                    ...
                    \Aboxed{v &= \SI{3e6}{\metre\per\second}}
                \end{align*}
                ...
                \begin{align*}
                    ...
                    \Aboxed{U &= \SI{9e16}{\joule\per\cubic\metre}}
                \end{align*}
            \end{enumerate}
